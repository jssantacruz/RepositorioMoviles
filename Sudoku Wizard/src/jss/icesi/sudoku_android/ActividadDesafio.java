...
public class ActividadDesafio extends Activity implements OnFocusChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		EditText prueba = (EditText) findViewById(R.id.f1c1c1);
		prueba.setOnFocusChangeListener(this);
	...
	public void onPause() {
		...
		myPrefs.edit()
				.putString("Reloj",
						new String("" + minuto + ";" + "" + segundo)).commit();
	...
	public String guardarSudoku() {
		...
		for (int j = 0; j < 81; j++) {
			...
			total = total + definitivo + ", posibles" + "," + fila + ","
					+ columna + "," + cuadrante + "#";
	...
	public void onFocusChange(View v, boolean hasFocus) {
		...
		if (hasFocus == false) {
			...
			try{
				...
				if (temp.getText().toString().equalsIgnoreCase("0") || temp.getText().toString().length()!=1) {
				
					Toast.makeText(getApplicationContext(), "IDIOTA",
